...
class VideoParams(BaseModel):
    ...
    # Karaoke mode: inactive words use text_fore_color; the spoken word uses this.
    subtitle_highlight_color: Optional[str] = "#FFFF00"
    # How many words stay on screen together in karaoke mode (short punchy phrases).
    karaoke_words_per_line: int = Field(default=4, ge=2, le=8)
